...
To explain PG simulation, consider initially  simulating from  the Gaussian model.   Given data $(q_t,z_t)$, $t=1,\ldots,n$ where
...
\section*{References}
\bibliography{/users/pietdejong/documents/research/piet2}
