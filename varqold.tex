...
\hline
 ...
 Geoff & Loudon & Associate & FBE& Investigator& geoff.loudon\\
         &                &  Professor                & Macquarie &                    &@mq.edu.au\    \\
                  &                & Applied Finace                                             & University &                    &            \\
          &                &                                            &  &                    &            \\
  Weihao &  Choo& Senior  & MSIG  &Investigator&chooweihao\\
           &                & Actuarial                                            & Holdings &                    &  @gmail.com          \\
           &                & Executive               & (Asia) &                    &    \\
  \hline
\end{tabular}
\end{center}
...
Our starting point for the proposed research is the recent literature,  CIFR targeted areas, and APRA regulatory aims and functions.
Recent literature includes
\cite{adrian2011covar}
\cite{acharya2012capital}
\cite{acharya2012measuring}
and \cite{brownlees2010volatility}.   The proposed research aims to extend and apply these techniques particularly in relation to the entities regulated by APRA and couched in terms of CIFR research targets mentioned above.    
...
$\covar_q$  proposed in \cite{adrian2011covar} suffers from a number of difficulties:
\bi
\i Couched in terms of $\var_q$, containing the scale of the original measurements.   It is worthwhile to have a scale independent measures.
and tie the same to actual scale of each loss in an explicit, more transparent way.  This allows for the separate,  modelling of scale and contagion  effects more consistent with actual systemic risk phenomena.
\i  Conditioning  on $\var_{0.5}$ is undesirable and relatively intractable.  In our proposed we reference stress with respect  to the unconditional $\var_q$.   This permits a more transparent analysis and estimation.   Furthermore our development is easily extensible to other risk metrics including tail var or expected worst outcome in say a decade.
\i  Our approach will econometrically relate scale and contagion effects  separately to external variables including shocks and drivers of systemic risk in the same spirit as \cite{brownlees2010volatility}.
\ei
...
\subsection*{Improved stress testing under contagion and external shocks}
